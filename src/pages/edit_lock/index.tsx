...
import EditLockContractContainer from "@dex/modules/EditLockContract/containers/EditLockContractContainer";
        ...
        <>
            <div className={styles.root}>
                ...
                <div className="tw-w-full">
                    <NavBarComponent value="/edit_lock" />
                </div>
